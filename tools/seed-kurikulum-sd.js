...
const PELAJARAN = [
  {
    ...
    tipe: 'materi',
    mufrodat: [
      { arab: 'كِتَابٌ', latin: 'Kitaabun', arti: 'Buku', contoh_kalimat: 'هَذَا كِتَابٌ جَدِيدٌ' },
      { arab: 'قَلَمٌ', latin: 'Qalamun', arti: 'Pena', contoh_kalimat: 'القَلَمُ عَلَى المَكْتَبِ' },
      { arab: 'دَفْتَرٌ', latin: 'Daftarun', arti: 'Buku tulis', contoh_kalimat: 'دَفْتَرِي أَزْرَقُ' },
      { arab: 'مِسْطَرَةٌ', latin: 'Mistharatun', arti: 'Penggaris', contoh_kalimat: 'المِسْطَرَةُ طَوِيلَةٌ' },
      { arab: 'مِمْحَاةٌ', latin: "Mimhaatun", arti: 'Penghapus', contoh_kalimat: 'أَيْنَ المِمْحَاةُ؟' },
      { arab: 'مِقْلَمَةٌ', latin: 'Miqlamatun', arti: 'Kotak pensil', contoh_kalimat: 'المِقْلَمَةُ فِي الحَقِيبَةِ' },
      { arab: 'كُرَّاسَةٌ', latin: 'Kurraasatun', arti: 'Buku latihan', contoh_kalimat: 'كُرَّاسَةُ الوَاجِبِ' },
      { arab: 'حَقِيبَةٌ', latin: 'Haqiibatun', arti: 'Tas sekolah', contoh_kalimat: 'حَقِيبَتِي ثَقِيلَةٌ' },
    ],
  },
  {
    ...
    tipe: 'materi',
    mufrodat: [
      { arab: 'فَصْلٌ', latin: 'Fashlun', arti: 'Ruang kelas', contoh_kalimat: 'الفَصْلُ نَظِيفٌ' },
      { arab: 'مَكْتَبٌ', latin: 'Maktabun', arti: 'Meja', contoh_kalimat: 'الكِتَابُ عَلَى المَكْتَبِ' },
      { arab: 'كُرْسِيٌّ', latin: 'Kursiyyun', arti: 'Kursi', contoh_kalimat: 'الكُرْسِيُّ صَغِيرٌ' },
      { arab: 'سَبُّورَةٌ', latin: 'Sabbuuratun', arti: 'Papan tulis', contoh_kalimat: 'السَّبُّورَةُ سَوْدَاءُ' },
      { arab: 'بَابٌ', latin: 'Baabun', arti: 'Pintu', contoh_kalimat: 'البَابُ مَفْتُوحٌ' },
      { arab: 'نَافِذَةٌ', latin: 'Naafidzatun', arti: 'Jendela', contoh_kalimat: 'النَّافِذَةُ وَاسِعَةٌ' },
      { arab: 'مَكْتَبَةٌ', latin: 'Maktabatun', arti: 'Perpustakaan', contoh_kalimat: 'أَذْهَبُ إِلَى المَكْتَبَةِ' },
      { arab: 'مُعَلِّمٌ', latin: "Mu'allimun", arti: 'Guru laki-laki', contoh_kalimat: 'المُعَلِّمُ فِي الفَصْلِ' },
    ],
  },
  {
